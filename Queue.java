...
public class Main {
    public static void main(String[] args) {
        ...
        queue.enqueue(40);    // Добавление элемента 40 в конец очереди

        System.out.println(queue.dequeue());    // Вывод и удаление элемента из начала очереди (20)
        System.out.println(queue.peek());       // Вывод элемента из начала очереди без его удаления (30)
        System.out.println(queue.dequeue());    // Вывод и удаление элемента из начала очереди (30)
